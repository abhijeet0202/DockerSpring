...
import org.abhibane.spring.learning.REST.BasicJson.Service.EmployeeService;
...
public class EmployeeController {
	...
	Employee create(@RequestBody Employee employee) {
		if (employee.getFirstName() != null && employee.getLastName() != null)
			...
			throw new NullPointerException("Employee information cannot be null");
	}
	...
	ResponseEntity<Employee> update(@RequestBody Employee employee) {
		if (employeeService.findById(employee.getId()).isPresent())
			...
			throw new ValidationException("Employee with employeeID: " + employee.getId() + " not present!");
	}
